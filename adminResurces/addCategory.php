...
<main>          
        <div class="container bg-light d-flex flex-column text-center p-5 mt-5">
            <h1>Add Category</h1>
            <form action="../phpActions/category.php" method="POST" class="m-4">
                <label for="category">Enter new book category</label>
                <input type="text" placeholder="Category" name="category" class="mb-4 border rounded pl-2 w-50" id="category"required><br>
  ...
  <tbody>
      ...
      foreach($categories as $category){
        ...
        <td>
         <a href="../phpActions/edit.php?id='.$category['id'].'" class="btn btn-warning mx-1">Edit</a>
         <a href="../phpActions/delete.php?id='.$category['id'].'&data=categories" class="btn btn-danger mx-1">Delete</a>
        </td>
        </tr>';
        }
