...
<html>
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="./commentSection.php">Comments section</a>
      </li>
    </ul>
...
<div class="container bg-light d-flex flex-column text-center p-5 mt-5">
            <h1>Add Book</h1>
            <form action="../phpActions/book.php" method="POST" class="m-4">
  ...
  <tbody>
      ...
      foreach($books as $book){
        ...
        <td>'.$book['category'].'</td> 
        <td>
         <a href="../phpActions/editBook.php?id='.$book['id'].'" class="btn btn-warning mx-1">Edit</a>
         <a href="../phpActions/deleteBook.php?id='.$book['id'].'" class="btn btn-danger mx-1">Delete</a>
        </td>
        </tr>';
        }
